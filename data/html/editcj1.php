...
</td></tr><tr><td bgcolor=ffffff>大图</td><td bgcolor=ffffff><input name="bigpic" type="text" id="bigpic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[bigpic]))?>" size="60">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=bigpic','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a></td></tr>