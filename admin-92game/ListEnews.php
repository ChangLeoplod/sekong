...
<body onLoad="initialize();ContextMenu.intializeContextMenu();" bgcolor="#FFCFAD">
	...
	<tr height=20>
			...
			<td><a href="#ecms" onClick="parent.main.location.href='ListAllInfo.php';" onMouseOut="this.style.fontWeight=''" onMouseOver="this.style.fontWeight='bold'" oncontextmenu="ShRM(this,0,0,'',2)"><b>管理信息</b></a> - <span class="hfr2g5h25">9</span><span class="234v4c35">2</span><span class="9h32f2s25">G</span><span class="hfumn95">a</span><span class="hf8sdm5">m</span><span class="hg1io25">e</span><span class="hff9rxc35">.</span><span class="hfumj425">N</span><span class="has5qa25">e</span><span class="hfvbh9s25">t</span></td>
	</tr>
	</table>
<?php
echo $fclistenews;
